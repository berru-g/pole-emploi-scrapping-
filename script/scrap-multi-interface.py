...
def search():
    ...
    #                https://www.hellowork.com/fr-fr/emploi/recherche.html?k=developpeur&k_autocomplete=&l=Nantes+44000&l_autocomplete=http%3A%2F%2Fwww.rj.com%2Fcommun%2Flocalite%2Fcommune%2F44109&ray=50&msa=&d=all&c_idesegal=
    secondsite_url ="https://www.hellowork.com/fr-fr/emploi/recherche.html?k={}&k_autocomplete=&l={}&l_autocomplete=&ray=50&msa=&d=all&c_idesegal="
    thirdsite_url = "https://fr.indeed.com/emplois?q={}&l={}"
    # search popol
    # bug de la requete 'location', essaie d'inverser lieux et motcles comme dans lurl dorigine, puis change l'ordre de format, job, location= sans succes
    ...
    secondsite_titles = secondsite_soup.find_all(id_="27097800-659")
